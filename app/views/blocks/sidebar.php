        ...
        <nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
            <ul class="app-menu list-unstyled accordion" id="menu-accordion">
                <li class="nav-item">
                    ...
                    <a class="nav-link active" href=<?php echo _WEB_ROOT."/home";?>>
                        <span class="nav-icon">
                ...
                <li class="nav-item">
                    <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                    <a class="nav-link" href=<?php echo _WEB_ROOT."/home/temperature";?>>
                        <span class="nav-icon">
                ...
                <li class="nav-item">
                    <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                    <a class="nav-link" href=<?php echo _WEB_ROOT."/home/soilHumid";?>>
                        <span class="nav-icon">
                ...
                <li class="nav-item has-submenu">
                    ...
                    <div id="submenu-1" class="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
                        <ul class="submenu-list list-unstyled">
                            <li class="submenu-item"><a class="submenu-link" href=<?php echo _WEB_ROOT."/home/device_notify";?>>Thông báo thiết bị</a></li>
                            <li class="submenu-item"><a class="submenu-link" href=<?php echo _WEB_ROOT."/home/device_manage";?>>Quản lý thiết bị</a></li>
                        </ul>
                    </div>
                </li><!--//nav-item-->
                <li class="nav-item has-submenu">
                ...
                <li class="nav-item">
                    <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                    <a class="nav-link" href=<?php echo _WEB_ROOT."/home/history";?>>
                        <span class="nav-icon">
                ...
                <li class="nav-item">
                    <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                    <a class="nav-link" href=<?php echo _WEB_ROOT."/home/account";?>>
                        <span class="nav-icon">
