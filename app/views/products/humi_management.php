<?php
echo 'Đây là danh sách quản lí độ ẩm';
...
<div class="container">
    ...
    <div class="body row">
        <div class="col col-8">
            <table class="table table-bordered text-left">
                ...
                <tr class="text-center fw-bold text-success text-left">
                    ...
                    <th scope="col" class="col col-2">Độ ẩm</th>
                    <th scope="col" class="col col-3">Máy bơm</th>
                </tr>
                </thead>
                <tbody>
                <tr>
        ...
        <div class="card col col-4" style="width: ">
            <div class="card-body">
                <h5 class="card-title text-center text-danger">Bật hệ thống bơm nước</h5>
