                                ...
                                <table class="table app-table-hover mb-0 text-left">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="cell"><span class="truncate">Có một con chó đi lạc</span></td>
                                            <td class="cell"><a role="button" class="btn-sm app-btn-secondary"
                                                                data-bs-toggle="modal" data-bs-target="#viewNotifyModal">Xem</a></td>
                                        </tr>
                                        <tr>
                                            <td class="cell"><span class="cell-data">16 Oct</span><span class="note">03:16 AM</span></td>
                                            <td class="cell"><span class="truncate">Admin đã xoá tài khoản abcd123</span></td>
                                            <td class="cell"><a role="button" class="btn-sm app-btn-secondary"
                                                                data-bs-toggle="modal" data-bs-target="#viewNotifyModal">Xem</a></td>
                                        </tr>
                                    </tbody>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header text-center">
                                                <h5 class="fw-bold">Có một con chó đi lạc</h5>
                                            </div>
                                            <div class="modal-body">
                                                Khu vực 2 phát hiện một con chó siu cute đang gặm bộ sensor.
                                                Vui lòng cầu xin chó buông tha nhanh!
                                            </div>
